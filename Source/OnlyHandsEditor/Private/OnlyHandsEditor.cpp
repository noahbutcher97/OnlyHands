...
void FOnlyHandsEditor::StartupModule() {
  UE_LOG(OnlyHandsEditor, Warning,
         TEXT("OnlyHandsEditor module has been loaded"));

  FPropertyEditorModule &PropertyModule =
      FModuleManager::LoadModuleChecked<FPropertyEditorModule>(
          "PropertyEditor");
  PropertyModule.RegisterCustomPropertyTypeLayout(
      HapticCurveName, FOnGetPropertyTypeCustomizationInstance::CreateStatic(
                           &OHHapticParameterCurveCustomization::MakeInstance));
}

void FOnlyHandsEditor::ShutdownModule() {
  UE_LOG(OnlyHandsEditor, Warning,
         TEXT("OnlyHandsEditor module has been unloaded"));

...
UCLASS(meta = (DisplayName = "Arm Compression Response",
               BlueprintInternalUseOnly = "true"))
class ONLYHANDSEDITOR_API UAnimGraphNode_ArmCompressionResponse
...
#if WITH_EDITOR
  virtual void
  ValidateAnimNodeDuringCompilation(USkeleton *ForSkeleton,

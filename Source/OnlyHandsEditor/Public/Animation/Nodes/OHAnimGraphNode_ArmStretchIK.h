...
class ONLYHANDSEDITOR_API UOHAnimGraphNode_ArmStretchIK
...
public:
  ...
  virtual bool
  IsCompatibleWithGraph(const UEdGraph *TargetGraph) const override {
    return TargetGraph &&
           TargetGraph->GetSchema()->IsA(UAnimationGraphSchema::StaticClass());
  }
};

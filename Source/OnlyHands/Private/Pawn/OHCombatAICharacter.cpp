...
AOHCombatAICharacter::AOHCombatAICharacter()
{
	...
	CombatAttributeSet = CreateDefaultSubobject<UOHCombatAttributeSet>(TEXT("CombatAttributeSet"));
...
// Called every frame
void AOHCombatAICharacter::Tick(float DeltaTime)
{
...
void AOHCombatAICharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	Super::SetupPlayerInputComponent(PlayerInputComponent);

}

UAbilitySystemComponent* AOHCombatAICharacter::GetAbilitySystemComponent() const
{

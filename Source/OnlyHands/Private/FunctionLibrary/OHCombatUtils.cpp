...
=======
	FVector SourceLocation, ERotationContext CurrentState, ERotationContext& NextState, ACharacter*& ClosestCharacter)
{
    // Add character robustly
    if (IsValid(Character) && !OverlappingCharacters.Contains(Character)) {
        OverlappingCharacters.Add(Character);
...
bool UOHCombatUtils::GetClosestCharacterToLocationFromActors(
    const FVector& SourceLocation, const TArray<AActor*>& Actors, ACharacter*& ClosestCharacter) {
...
<<<<<<< HEAD
                ...
                void UOHCombatUtils::SortContactsByImpactScore_Raw(TArray<FVector> & Velocities,
                                                                   TArray<FVector> & Normals, TArray<float> & Forces,
...
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
                ...
                void UOHCombatUtils::FilterRedundantHitsByActor(const TArray<AActor*>& HitActors,
                                                                TArray<int32>& OutUniqueIndices) {
                    TSet<AActor*> Seen;
                ...
                void UOHCombatUtils::DrawDebugPath(const UObject* WorldContextObject, const TArray<FVector>& Points,
                                                   FColor Color, float Duration, float Thickness, bool bLoop,
                ...
                void UOHCombatUtils::DrawDebugStrikeCone(const UObject* WorldContextObject, const FVector& Origin,
                                                         const FVector& Velocity, float Length, float AngleDegrees,
                ...
                FVector UOHCombatUtils::GetBoneLinearVelocity(const USkeletalMeshComponent* Mesh, FName BoneName,
                                                              float DeltaTime) {
                ...
                FVector UOHCombatUtils::ComputeBoneVelocityMeshRelative(const USkeletalMeshComponent* Mesh,
                ...
                FVector UOHCombatUtils::PredictBonePositionFromAnimation(const USkeletalMeshComponent* Mesh,
                                                                         FName BoneName, float TimeOffset) {
                ...
                void UOHCombatUtils::DetectContactAlongStrikeArc(
                    const UObject* WorldContextObject, const TArray<FVector>& ArcPoints, TArray<FHitResult>& OutHits,
                    ECollisionChannel TraceChannel, float SegmentThickness) {
                    OutHits.Reset();
                ...
                void UOHCombatUtils::SweepCapsuleAlongStrikeArc(
                    const UObject* WorldContextObject, const TArray<FVector>& ArcPoints, float Radius, float HalfHeight,
                ...
                bool UOHCombatUtils::DetectGJKContactFromStrikeArc(
                    ...
                    bool bGJK = UOHCollisionUtils::GJK_Intersect(ArcHull, TargetConvexPoints, Simplex, SupportA,
                                                                 SupportB, MaxIterations, Tolerance);
                    ...
                    bool bEPA = UOHCollisionUtils::EPA_PenetrationDepth(ArcHull, TargetConvexPoints, Simplex, Normal,
                                                                        Depth, MaxIterations, Tolerance);
                ...
                static bool SampleStrikeArc_Internal(UAnimSequence * Sequence, USkeletalMeshComponent * Mesh,
                                                     FName BoneName, const TArray<float>& SampleTimes,
                ...
                void UOHCombatUtils::GenerateStrikeArcFromLiveMesh(const USkeletalMeshComponent* Mesh, FName BoneName,
                                                                   int32 NumSamples, float SampleInterval,
                                                                   TArray<FVector>& OutArc) {
                    OutArc.Reset();
                ...
                bool UOHCombatUtils::GenerateStrikeArcFromAnimBase(
                    UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName, float StartTime,
                    float EndTime, TArray<FVector>& OutPoints, float SampleRate) {
                    if (!AnimBase || !Mesh) {
                    ...
                    if (!Sequence) {
                        UE_LOG(LogTemp, Warning, TEXT("[OH] No valid sequence extracted from AnimBase at time %.2f"),
                               QueryTime);
                        return false;
                    }
                    ...
                    return GenerateStrikeArcFromAnimSequence(Sequence, Mesh, BoneName, ClampedStart, ClampedEnd,
                                                             OutPoints, SampleRate);
                }
                bool UOHCombatUtils::GenerateStrikeArcFromAnimSequence(
                    UAnimSequence * Sequence, USkeletalMeshComponent * Mesh, FName BoneName, float StartTime,
                    float EndTime, TArray<FVector>& OutPoints, float SampleRate) {
                ...
                bool UOHCombatUtils::GenerateStrikeArcFromAnimSequence_FixedResolution(
                    UAnimSequence * Sequence, USkeletalMeshComponent * Mesh, FName BoneName, int32 NumSamples,
                ...
                bool UOHCombatUtils::GenerateStrikeArcFromComposite(
                    UAnimComposite * Composite, USkeletalMeshComponent * Mesh, FName BoneName, float StartTime,
                    float EndTime, TArray<FVector>& OutPoints, float SampleRate) {
                    if (!Composite || !Mesh) {
                    ...
                    if (!Sequence) {
                        UE_LOG(LogTemp, Warning, TEXT("[OH] No valid sequence extracted from Composite at time %.2f"),
                               QueryTime);
                        return false;
                    }
                ...
                bool UOHCombatUtils::GenerateStrikeArcFromMontage(UAnimMontage * Montage, USkeletalMeshComponent * Mesh,
                    ...
                    if (!Sequence) {
                        UE_LOG(LogTemp, Warning, TEXT("[OH] No valid sequence extracted from Montage at time %.2f"),
                               QueryTime);
                        return false;
                    }
                ...
                void UOHCombatUtils::VisualizeBoneMotionArcFromAnim(
                    const UObject* WorldContextObject, UAnimSequenceBase* AnimBase, USkeletalMeshComponent* Mesh,
                    FName BoneName, int32 NumSamples, FName MontageSectionName, FColor Color, float Duration,
                    float Thickness, bool bLoop, bool bDrawVelocity, bool bDrawImpactNormals) {
                        ...
                        if (!MontageSectionName.IsNone()) {
                            ...
                            if (SectionIndex != INDEX_NONE) {
                                ...
                                UE_LOG(LogTemp, Warning,
                                       TEXT("VisualizeBoneMotionArcFromAnim: Montage section '%s' not found."),
                    ...
                    if (!UOHCombatUtils::GenerateStrikeArcFromAnimBase(
                            ...
                            NumSamples / (EndTime - StartTime))) // Convert NumSamples to SampleRate
                    {
                    ...
                    if (bDrawVelocity || bDrawImpactNormals) {
                        for (int32 i = 1; i < ArcPoints.Num(); ++i) {
                            ...
                            if (bDrawVelocity) {
                                DrawDebugLine(WorldContextObject->GetWorld(), Start, Start + Velocity * 20.f,
                            ...
                            if (bDrawImpactNormals && i < ArcPoints.Num() - 1) {
                                ...
                                DrawDebugLine(WorldContextObject->GetWorld(), End, End + Normal * 20.f, FColor::Cyan,
                ...
                void UOHCombatUtils::VisualizePredictedArc(
                    const UObject* WorldContextObject, USkeletalMeshComponent* Mesh, FName BoneName,
                    float PredictionWindow, int32 NumSamples, FColor Color, float Duration, float Thickness,
                    bool bDrawVelocity, bool bDrawImpactNormals) {
                    ...
                    if (!UOHCombatUtils::ExtractActiveSequenceAndTimeFromMesh(Mesh, Sequence, LocalTime) || !Sequence) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("VisualizePredictedArcFromNow: Failed to extract active sequence."));
                        return;
                    }
                    ...
                    for (int32 i = 1; i < ArcPoints.Num(); ++i) {
                        ...
                        if (bDrawImpactNormals && i < ArcPoints.Num() - 1) {
                            ...
                            DrawDebugLine(WorldContextObject->GetWorld(), End, End + Normal * 20.f, FColor::Cyan, false,
                                          Duration, 0, 1.0f);
                        }
                    }
                }
                ...
                FCombatStrikePredictionResult UOHCombatUtils::PredictStrikeCollision(
                    const UObject* WorldContextObject, ACharacter* Attacker, UOHPhysicsManager* PhysicsManager,
                    FName BoneName, float PredictionTime, int Steps, bool bEnableDebug) {
                    ...
                    for (TActorIterator<ACharacter> It(World); It; ++It) {
                        ...
                        float DistSq =
                            FVector::DistSquared(Attacker->GetActorLocation(), Candidate->GetActorLocation());
                ...
                FCombatStrikePredictionResult UOHCombatUtils::AnalyzeStrikeTrajectoryAndTargeting(
                    const UObject* WorldContextObject, ACharacter* Attacker, UOHPhysicsManager* PhysicsManager,
                    FName StrikeBone, float PredictionTime, int Steps, bool bEnableDebug, FName DebugTag) {
                    FCombatStrikePredictionResult Result;
                    ...
                    TArray<FName> BoneChain =
                        UOHSkeletalPhysicsUtils::GetBoneChainBetweenByName(Mesh, RootBone, StrikeBone);
                    if (BoneChain.Num() == 0)
                    ...
                    if (bEnableDebug) {
                        ...
                        DrawDebugDirectionalArrow(World, AvgStart, BestTargetBoneLoc, 150.f, FColor::Red, false, 2.f, 0,
                                                  3.0f);
                ...
                FCombatStrikePredictionResult UOHCombatUtils::AnalyzeAdvancedStrikeTrajectory3D(
                    const UObject* WorldContextObject, ACharacter* Attacker, UOHPhysicsManager* PhysicsManager,
                    FName StrikeBone, float PredictionTime, int Steps, bool bEnableDebug, FName DebugTag,
                    FName OptionalChainStart, int32 MaxChainDepth, bool bIsFullBodyAnimation,
                    ...
                    for (const FName& Bone : BoneChain) {
                        ...
                        if (bEnableDebug) {
                            ...
                            DrawDebugString(World, BoneData->GetCurrentPosition() + FVector(0, 0, 10), Bone.ToString(),
                    ...
                    // --- 3. Pose Deformation ---
                    float FullExtension =
                        FVector::Dist(Mesh->GetBoneLocation(BoneChain[0]), Mesh->GetBoneLocation(StrikeBone));
                    float MaxChainLength = 0.f;
                    for (int32 i = 1; i < BoneChain.Num(); ++i) {
                        MaxChainLength +=
                            FVector::Dist(Mesh->GetBoneLocation(BoneChain[i - 1]), Mesh->GetBoneLocation(BoneChain[i]));
                    }
                    ...
                    for (int32 Step = 1; Step <= Steps; ++Step) {
                        ...
                        if (bEnableDebug) {
                            FLinearColor LinearColor = FLinearColor::LerpUsingHSV(
                                FLinearColor::Green, FLinearColor::Red, Step / static_cast<float>(Steps));
                            ...
                            DrawDebugString(World, Predicted + FVector(0, 0, 12), FString::Printf(TEXT("T: %.2f"), T),
                                            nullptr, StepColor, 2.f);
                        }
                    }
                ...
                FCombatStrikePredictionResult UOHCombatUtils::AnalyzeAdvancedStrikeTrajectory2D(
                    ...
                    for (const FName& Bone : BoneChain) {
                        ...
                        if (bEnableDebug) {
                            ...
                            DrawDebugString(World, Data->GetCurrentPosition() + FVector(0, 0, 10), Bone.ToString(),
                                            nullptr, FColor::White, 2.f);
                        }
                    }
                    if (ValidBones.Num() == 0)
                    ...
                    for (int32 Step = 1; Step <= Steps; ++Step) {
                        ...
                        StepPos +=
                            Tangent * (ArcRadius * FMath::Sin((AngularVel.Size() + AngularAccel.Size() * T) * T));

                        // Project X and Z, keep actual Z height
                        StepPos =
                            FVector(StepPos.X, Start.Y, StepPos.Z); // maintains height, fixes “on the floor” issue
                        ...
                        if (bEnableDebug) {
                            ...
                            DrawDebugString(World, StepPos + FVector(0, 0, 10), FString::Printf(TEXT("T: %.2f"), T),
                                            nullptr, FColor::White, 2.f);
                        }
                    }
                    if (BestTargetBone.IsNone())
...
#pragma region Sampling
                ...
                FOHBoneMotionSample UOHCombatUtils::SampleBoneMotionFromAnimBase(
                    UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName, int32 NumSamples,
                    float StartTime, float EndTime, FName MontageSectionName, bool bDrawDebug, FColor DebugColor,
                    float DebugDuration, float DebugThickness) {
                    FOHBoneMotionSample Result = SampleBoneMotionInternal(AnimBase, Mesh, BoneName, NumSamples,
                ...
                FOHBoneMotionSample UOHCombatUtils::SampleBoneMotionFromAnimBasePure(
                    UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName, int32 NumSamples,
                    float StartTime, float EndTime, FName MontageSectionName) {
                    return SampleBoneMotionInternal(AnimBase, Mesh, BoneName, NumSamples, StartTime, EndTime,
                                                    MontageSectionName);
                }
                ...
                FOHBoneMotionSample UOHCombatUtils::SampleBoneMotionInternal(
                    ...
                    const double T0 =
                        FMath::Clamp(static_cast<double>(StartTime), 0.0, static_cast<double>(AssetDuration));
                    const double T1 =
                        FMath::Clamp(static_cast<double>(EndTime), T0, static_cast<double>(AssetDuration));
                    ...
                    if (!Sequence) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[SampleBoneMotion] Could not resolve sequence at time %.2f in %s"), T0,
                    ...
                    for (int32 i = 0; i < NumSamples; ++i) {
                        ...
                        FTransform BoneTransform;
                        if (UOHCombatUtils::GetBoneTransformAtTime(Sequence, Mesh, BoneName, static_cast<float>(Time),
                                                                   BoneTransform)) {
                            const FVector Pos = BoneTransform.GetLocation();
                            if (!Pos.ContainsNaN()) {
                    ...
                    if (Result.NumPoints > 1) {
                        UOHCombatUtils::SampleMotionDerivatives(Result.Points, SampleInterval, Result.Velocities,
                ...
                void UOHCombatUtils::ScheduleDeferredBoneArcSample(
                    UObject * WorldContext, UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName,
                    int32 NumSamples, FName MontageSectionName, FColor DebugColor, float Duration, float Thickness) {
                    ...
                    TimerCallback.BindLambda([=]() {
                        ...
                        UOHCombatUtils::VisualizeBoneMotionArcFromAnim(WorldContext, WeakAnim.Get(), WeakMesh.Get(),
                                                                       BoneName, NumSamples, MontageSectionName,
                                                                       DebugColor, Duration, Thickness);
                    });
	...
	FName MontageSectionName)
{
	...
	return Result;
                ...
                bool UOHCombatUtils::GetBoneTransformAtTime(UAnimSequence * Sequence, USkeletalMeshComponent * Mesh,
                    ...
                    if (!CompactIndex.IsValid()) {
                        UE_LOG(LogTemp, Error, TEXT("[OH] Invalid compact pose index for bone '%s'"),
                               *BoneName.ToString());
                        return false;
                    }
                ...
                bool UOHCombatUtils::GetBoneTransformFromAnimBase(
                    UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName, double Time,
                    FTransform& OutTransform, bool bWorldSpace) {
                ...
                bool UOHCombatUtils::GetBoneRotationAtTime(UAnimSequence * Sequence, USkeletalMeshComponent * Mesh,
                                                           FName BoneName, double Time, FRotator& OutRotation,
                                                           bool bWorldSpace) {
                    FTransform BoneTransform;
                    const bool bSuccess =
                        bWorldSpace ? GetBoneTransformWorldAtTime(Sequence, Mesh, BoneName, Time, BoneTransform)
                ...
                bool UOHCombatUtils::GetBoneVelocityAtTime(UAnimSequence * Sequence, USkeletalMeshComponent * Mesh,
                                                           FName BoneName, double Time, FVector& OutVelocity,
                                                           float SampleWindow) {
                ...
                FTransform UOHCombatUtils::GetBoneComponentSpaceTransformAtTime(
                    UAnimSequence * AnimSequence, const USkeletalMeshComponent* Mesh, FName BoneName, double Time) {
                    ...
                    if (BoneIndex == INDEX_NONE) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[OH] [GetBoneComponentSpaceTransformAtTime] Bone '%s' not found in mesh."),
                               *BoneName.ToString());
                        return FTransform::Identity;
                    }
                ...
                void UOHCombatUtils::ComputeMotionDerivatives(const TArray<FVector>& Points, float SampleDelta,
                                                              ...
                                                              TArray<FVector>& OutAccelerations) {
                    ...
                    for (int32 i = 0; i < Count; ++i) {
                        if (i == 0) {
                            ...
                            OutAccelerations[i] =
                                (Points[i + 1] - 2.f * Points[i] + Points[i - 1]) / (SampleDelta * SampleDelta);
                        }
                    }
                }

                bool UOHCombatUtils::ResolveAnimSequenceAtTimeRecursive(
                    UAnimSequenceBase * AnimBase, float Time, UAnimSequence*& OutSequence, float& OutLocalTime) {
                    if (!AnimBase) {
                        ...
                        for (const FAnimSegment& Segment : Segments) {
                            ...
                            if (Time >= Start && Time <= End) {
                                if (UAnimSequenceBase* Nested = Segment.GetAnimReference()) {
                                    return ResolveAnimSequenceAtTimeRecursive(Nested, Time - Start, OutSequence,
                                                                              OutLocalTime);
                                }
                            }
                        }
                    ...
                    UE_LOG(LogTemp, Warning,
                           TEXT("[ResolveAnimSequenceAtTimeRecursive] Could not resolve sequence at time %.3f in %s"),
                           Time, *GetNameSafe(AnimBase));
                    return false;
                }

                UAnimSequence* UOHCombatUtils::ExtractSequenceFromAnimBaseAtTime(UAnimSequenceBase * AnimBase,
                                                                                 float Time) {
                    if (!AnimBase)
                        return nullptr;
                    ...
                    const bool bResolved =
                        ResolveAnimSequenceAtTimeRecursive(AnimBase, Time, OutSequence, OutLocalTime);
                    if (!bResolved || !OutSequence) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("ExtractSequenceFromAnimBaseAtTime: No sequence found at time %.3f in %s"), Time,
                               *GetNameSafe(AnimBase));
                    }
                ...
                UAnimSequence* UOHCombatUtils::ExtractActiveSequenceFromMesh(USkeletalMeshComponent * Mesh) {
                    ...
                    if (!Sequence) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("ExtractActiveSequenceFromMesh: Could not extract sequence at time %.2f from %s"),
                               PlaybackTime, *Montage->GetName());
                    } else {
                        UE_LOG(LogTemp, Log, TEXT("ExtractActiveSequenceFromMesh: Resolved '%s' at time %.2f"),
                ...
                bool UOHCombatUtils::ExtractActiveSequenceAndTimeFromMesh(
                    USkeletalMeshComponent * Mesh, UAnimSequence * &OutSequence, float& OutLocalTime) {
                    OutSequence = nullptr;
                    OutLocalTime = 0.f;
                ...
                void UOHCombatUtils::StartTimedBoneArcSampling(
                    UObject * WorldContextObject, USkeletalMeshComponent * Mesh, FName BoneName, float Duration,
                    int32 NumSamples, TFunction<void(const TArray<FVector>&)> OnComplete) {
                ...
                bool UOHCombatUtils::GetBoneWorldSpaceVelocityAtTime(
                    UAnimSequence * Sequence, const USkeletalMeshComponent* Mesh, FName BoneName, float Time,
                    FVector& OutVelocity, float SampleWindow) {
                    OutVelocity = FVector::ZeroVector;
                ...
                void UOHCombatUtils::VisualizeMotionDerivatives(
                    const UObject* WorldContextObject, const TArray<FVector>& Points, const TArray<FVector>& Velocities,
                    const TArray<FVector>& Accelerations, float Duration, float Scale, float Thickness) {
                    if (!WorldContextObject || Points.Num() < 2 || Velocities.Num() != Points.Num() ||
                        Accelerations.Num() != Points.Num()) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[OH] VisualizeMotionDerivatives: Mismatched or invalid input arrays."));
                        return;
                    }
                ...
                FOHBoneMotionSample UOHCombatUtils::GenerateBoneMotionSample(
                    UAnimSequenceBase * AnimBase, USkeletalMeshComponent * Mesh, FName BoneName, int32 NumSamples,
                    FName MontageSectionName, float StartTime, float EndTime) {
                    ...
                    if (NumSamples < 2) {
                        UE_LOG(LogTemp, Warning, TEXT("[OH] GenerateBoneMotionSample: NumSamples too low (%d)"),
                               NumSamples);
                        return Sample;
                    }
                    ...
                    if (bCallerProvidedRange) {
                        if (StartTime < 0.f || EndTime < 0.f || StartTime >= EndTime || EndTime > MaxDuration) {
                            UE_LOG(LogTemp, Warning,
                                   TEXT("[OH] GenerateBoneMotionSample: Invalid time range provided (%.2f → %.2f), "
                                        "Max: %.2f"),
                    ...
                    Sample = SampleBoneMotionInternal(AnimBase, Mesh, BoneName, NumSamples, StartTime, EndTime,
                                                      MontageSectionName);

                    if (Sample.Points.Num() < 2) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[OH] GenerateBoneMotionSample: Insufficient motion points returned"));
                    }
                ...
                void UOHCombatUtils::TestVisualizeBoneMotionArcFromMesh(
                    USkeletalMeshComponent * Mesh, FName BoneName, float PredictDuration, int32 NumSamples,
                    FColor DebugColor, float DebugLineDuration, float LineThickness, bool bLoop) {
                    ...
                    if (!bSuccess || ArcPoints.Num() < 2) {
                        UE_LOG(LogTemp, Warning, TEXT("[OH] TestVisualize: Failed to generate arc for bone %s."),
                               *BoneName.ToString());
                        return;
                    }

                    UE_LOG(LogTemp, Log, TEXT("[OH] Drawing test arc (%d pts) for bone %s from %.2f → %.2f"),
                ...
                void UOHCombatUtils::TestDrawArcFromMesh(USkeletalMeshComponent * Mesh, FName BoneName, float Duration,
                                                         FColor Color) {
                    if (!Mesh || BoneName.IsNone())
                        return;
                    ...
                    TArray<FVector> ArcPoints;
                    const bool bSuccess =
                        GenerateStrikeArcFromAnimSequence(Sequence, Mesh, BoneName, StartTime, EndTime, ArcPoints);

                    if (!bSuccess || ArcPoints.Num() < 2) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[OH] TestDrawArcFromMesh: Arc gen failed or insufficient points."));
                        return;
                    }
                ...
                void UOHCombatUtils::QuickDrawBoneArcFromMesh(USkeletalMeshComponent * Mesh, FName BoneName,
                                                              float PredictDuration, FColor Color, float Duration,
                                                              float Thickness) {
                    if (!Mesh || BoneName.IsNone()) {
                    ...
                    if (!ResolveAnimSequenceAtTimeRecursive(Montage, MontageTime, Sequence, LocalTime)) {
                        UE_LOG(LogTemp, Error, TEXT("[OH] Could not resolve sequence from montage at %.2f"),
                               MontageTime);
                        return;
                    }
                    ...
                    UE_LOG(LogTemp, Log, TEXT("[OH] Drawing arc from %.2f to %.2f with %d points"), T0, T1,
                           ArcPoints.Num());
                ...
                void UOHCombatUtils::ScheduleDeferredArcDraw(USkeletalMeshComponent * Mesh, FName BoneName,
                                                             float PredictDuration, FColor DebugColor, float Duration,
                                                             float Thickness) {
                    if (!Mesh || BoneName.IsNone()) {
                    ...
                    World->GetTimerManager().SetTimer(
                        ...
                        [=]() {
                            ...
                            if (ArcPoints.Num() >= 2) {
                                ...
                                DrawDebugBox(World, FVector(0, 0, 100), FVector(10, 10, 10), FColor::Magenta, true,
                                             Duration);
                            }
                        },
                        0.01f, false);
                ...
                void UOHCombatUtils::GetBoneChainAngularMotion(
                    UOHPhysicsManager * PhysicsManager, const TArray<FName>& BoneChain, FVector& OutAngularVelocity,
                ...
                FVector UOHCombatUtils::GetBlendedChainVelocity(
                    UOHPhysicsManager * PhysicsManager, const USkeletalMeshComponent* Mesh, const FName StartBone,
                ...
                void UOHCombatUtils::GetBlendedBoneChainMotion(
                    UOHPhysicsManager * PhysicsManager, const TArray<FName>& BoneChain, float HistoryWeight,
                    int NumSamples, FVector& OutVelocity, FVector& OutAcceleration, FVector& OutStartLocation,
                    FVector& OutForward) {
                    OutVelocity = FVector::ZeroVector;
                ...
                void UOHCombatUtils::GetBlendedBoneChainMotionData(
                    UOHPhysicsManager * PhysicsManager, const TArray<FName>& BoneChain, float HistoryWeight,
                    int NumSamples, FVector& OutVelocity, FVector& OutAcceleration, FVector& OutStartLocation,
                    FVector& OutForward, FVector& OutAngularVelocity, FVector& OutAngularAcceleration,
                ...
                void UOHCombatUtils::GetBlendedBoneChainMotionFromStrikeBone(
                    UOHPhysicsManager * PhysicsManager, const USkeletalMeshComponent* Mesh, FName StrikeBone,
                    FName ChainStart, int32 MaxDepth, bool bIsFullBodyAnimation, float HistoryWeight, int NumSamples,
                    FVector& OutVelocity, FVector& OutAcceleration, FVector& OutStartLocation, FVector& OutForward,
                    FVector& OutAngularVelocity, FVector& OutAngularAcceleration, float& OutJitterScore) {
                    OutVelocity = FVector::ZeroVector;
                    OutAcceleration = FVector::ZeroVector;
                    OutStartLocation = FVector::ZeroVector;
                    OutForward = FVector::ZeroVector;
...
#pragma region MotionWarping
                ...
                void UOHCombatUtils::AddWarpTargetToNearestEnemy(UMotionWarpingComponent * MotionWarpingComponent,
                                                                 float SearchRadius, FName WarpTargetName) {
                    ...
                    if (ClosestTarget) {
                        ...
                        if (UCapsuleComponent* Capsule = ClosestTarget->GetCapsuleComponent()) {
                            DrawDebugCapsule(World, TargetLocation, Capsule->GetScaledCapsuleHalfHeight(),
                                             Capsule->GetScaledCapsuleRadius(), FQuat::Identity, FColor::Red, false,
                                             2.0f, 0, 2.0f);
                        }
                ...
                float UOHCombatUtils::ComputeImpulseVulnerabilityScore(
                    const FOHBoneData& BoneData, const FVector& ImpactDirection, const FVector& RootLocation) {
                    if (!BoneData.IsValid()) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[CombatUtils] Invalid bone data in vulnerability score computation."));
                        return 0.0f;
                    }
...
#if WITH_EDITOR
                    UE_LOG(LogTemp, Verbose, TEXT("[CombatUtils] Vulnerability Score: Dot = %.2f → Score = %.2f"), Dot,
                           Score);
#endif
                ...
                FVector UOHCombatUtils::ComputeImpulseVectorForBone(
                    ...
                    const FVector& RootLocation, float BaseStrength, EOHImpulseMode ModeOverride, bool bAutoInferMode,
                    EImpulseDirectionMode DirectionMode) {
                    const FOHBoneData* Bone = Graph.FindBoneData(BoneName);
                    if (!Bone || !Bone->IsValid()) {
                        UE_LOG(LogTemp, Warning, TEXT("ComputeImpulseVectorForBone: Invalid bone %s"),
                               *BoneName.ToString());
                        return FVector::ZeroVector;
                    }
                    ...
                    float Multiplier =
                        ComputeImpulseVulnerabilityScore(Graph, BoneName, ImpulseDirection, RootLocation);
...
#pragma region ForceFeedback
                ...
                FVector UOHCombatUtils::GetImpulseDirectionFromBoneToImpactPoint(const FOHBoneData& BoneData,
                ...
                float UOHCombatUtils::ComputeImpulseStrengthFromNormal(const FOHBoneData& BoneData,
                                                                       const FHitResult& Hit, float BaseMultiplier) {
                ...
                float UOHCombatUtils::ComputeImpulseStrengthFromBoneData(
                    const FOHBoneData& BoneData, const FVector& OptionalStrikeDir, float BaseMultiplier) {
                    if (!BoneData.IsValid() || !BoneData.HasMotionHistory()) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[CombatUtils] Invalid or missing bone data — impulse strength defaulted to 0"));
                        return 0.f;
                    }
                    ...
                    if (!OptionalStrikeDir.IsNearlyZero()) {
                        ...
                        const float Dot =
                            FVector::DotProduct(BoneVelocity.GetSafeNormal(), OptionalStrikeDir.GetSafeNormal());
                        DirectionScore = FMath::Clamp(Dot, 0.f, 1.f); // Emphasize forward-aligned strikes
                    }

                    // Weighted scoring formula
                    const float WeightedScore = (LinearSpeed * 0.5f) + (AngularSpeed * 0.2f) + (LinearAccelMag * 0.2f) +
...
#if WITH_EDITOR
                    UE_LOG(LogTemp, Log,
                           TEXT("[CombatUtils] ImpulseStrength: %.2f (Linear: %.2f, Angular: %.2f, Accel: %.2f, "
                                "DirScore: %.2f)"),
...
#if WITH_EDITOR
                    UE_LOG(LogTemp, Log,
                           TEXT("[CombatUtils] ImpulseStrength: Base = %.2f | Multiplier = %.2f | Final = %.2f"),
...
#if WITH_EDITOR
                    UE_LOG(LogTemp, Log,
                           TEXT("[CombatUtils] Impulse Vector (%s): Strength = %.2f | Direction = %s | Result = %s"),
                ...
                FVector UOHCombatUtils::ComputeImpulseVectorFromHitNormal(const FOHBoneData& BoneData,
                                                                          const FHitResult& Hit, float BaseMultiplier) {
                    const FVector Dir = GetImpulseDirectionFromHitNormal(Hit);
                    const float Strength = ComputeImpulseStrengthFromBoneData(BoneData, Dir, BaseMultiplier);
                    return Dir * Strength;
                ...
                EImpulseDirectionMode UOHCombatUtils::InferBestImpulseDirectionMode(
                    const FOHBoneData& BoneData, const FHitResult& Hit, float AlignmentThreshold) {
                    if (!BoneData.IsValid() || !Hit.bBlockingHit)
...
#if WITH_EDITOR
                    UE_LOG(LogTemp, Log, TEXT("[SelfImpulse] VelDot=%.2f | Ang=%.2f | Dist=%.2f | Final=%.2f"),
                ...
                FVector UOHCombatUtils::ComputeImpulseVectorFromBone(
                    const FOHBoneData& BoneData, const FHitResult& Hit, const FVector& RootLocation, float BaseStrength,
...
#pragma endregion
                ...
                AActor* UOHCombatUtils::FindFuzzyTarget(const AActor* SelfActor, const FString& ContextualHint) {
                    ...
                    if (!World) {
                        UE_LOG(LogTemp, Warning,
                               TEXT("[FindMostLikelyOpponent] Could not get world from SelfActor [%s]"),
                               *SelfActor->GetName());
                        return nullptr;
                    }
                ...
                bool UOHCombatUtils::PredictiveCapsuleGroundTrace(
                    USkeletalMeshComponent * Mesh, FName BoneName, float MaxDistance, float TraceForwardBias,
                    float CapsuleRadius, float CapsuleHalfHeight, const FVector& OwnerVelocity, FHitResult& OutHit,
                    bool bDrawDebug) {
                    if (!Mesh)
                        return false;
                    ...
                    if (bDrawDebug) {
                        ...
                        DrawDebugCapsule(Mesh->GetWorld(), PredictedStart, CapsuleHalfHeight, CapsuleRadius,
                                         FQuat::Identity, TraceColor, false, 0.05f, 0, 1.0f);
                        ...
                        if (bHit) {
                            ...
                            DrawDebugDirectionalArrow(Mesh->GetWorld(), OutHit.ImpactPoint,
                                                      OutHit.ImpactPoint + OutHit.ImpactNormal * 30.f, 16.f,
                                                      FColor::Yellow, false, 0.1f, 0, 1.5f);
                        }
                    }
                    return bHit;
                }
...
<<<<<<< HEAD
                        if (Attacker) {
                            ...
                            USkeletalMeshComponent* AttackerMesh =
                                Attacker->FindComponentByClass<USkeletalMeshComponent>();
                                    ...
                                    == == == = if (Attacker) {
                                        ...
                                        if (AttackerMesh && AttackerMesh->GetBodyInstance()) {
                                            ...
                                            UPrimitiveComponent* PrimComp =
                                                Attacker->FindComponentByClass<UPrimitiveComponent>();
                                            if (PrimComp) {
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
...
<<<<<<< HEAD
                                    if (Target) {
                                        ...
                                        if (TargetMesh && TargetMesh->GetBodyInstance()) {
                                            ...
                                            UPrimitiveComponent* PrimComp =
                                                Target->FindComponentByClass<UPrimitiveComponent>();
                                            if (PrimComp) {
                                                == == == = if (Target) {
                                                    USkeletalMeshComponent* TargetMesh =
                                                        Target->FindComponentByClass<USkeletalMeshComponent>();
...
<<<<<<< HEAD
                                                if (!FMath::IsFinite(AttackerMass) || AttackerMass <= 0.0f) {
                                                    if (bVerbose) {
                                                        UE_LOG(LogTemp, Warning,
                                                               TEXT("OHCombatUtils::CalculateMassRatio: Invalid "
                                                                    "Attacker mass (%.2f), using 1.0f"),
                                                               AttackerMass);
                                                    }
                                                    AttackerMass = 1.0f;
                                                }
                                                if (!FMath::IsFinite(TargetMass) || TargetMass <= 0.0f) {
                                                    if (bVerbose) {
                                                        UE_LOG(LogTemp, Warning,
                                                               TEXT("OHCombatUtils::CalculateMassRatio: Invalid Target "
                                                                    "mass (%.2f), using 1.0f"),
                                                               TargetMass);
                                                        == == == = if (!FMath::IsFinite(AttackerMass) ||
                                                                       AttackerMass <= 0.0f) {
                                                            if (bVerbose) {
                                                                UE_LOG(LogTemp, Warning,
                                                                       TEXT("OHCombatUtils::CalculateMassRatio: "
                                                                            "Invalid Attacker mass (%.2f), using 1.0f"),
                                                                       AttackerMass);
                                                            }
                                                            AttackerMass = 1.0f;
                                                        }
                                                        if (!FMath::IsFinite(TargetMass) || TargetMass <= 0.0f) {
                                                            if (bVerbose) {
                                                                UE_LOG(LogTemp, Warning,
                                                                       TEXT("OHCombatUtils::CalculateMassRatio: "
                                                                            "Invalid Target mass (%.2f), using 1.0f"),
                                                                       TargetMass);
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
                                                            }
                                                            TargetMass = 1.0f;
...
<<<<<<< HEAD
                                                        if (bVerbose) {
                                                            UE_LOG(
                                                                LogTemp, Log,
                                                                TEXT("OHCombatUtils::CalculateMassRatio: "
                                                                     "AttackerMass=%.2f, TargetMass=%.2f, Ratio=%.2f"),
                                                                AttackerMass, TargetMass, Ratio);
                                                            == == == = if (bVerbose) {
                                                                UE_LOG(LogTemp, Log,
                                                                       TEXT("OHCombatUtils::CalculateMassRatio: "
                                                                            "AttackerMass=%.2f, TargetMass=%.2f, "
                                                                            "Ratio=%.2f"),
                                                                       AttackerMass, TargetMass, Ratio);
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
                                                            }
...
<<<<<<< HEAD
                                                        float UOHCombatUtils::CalculateChainMass(
                                                            AActor * Actor, const TArray<FName>& BoneNames,
                                                            bool bAverage, bool bVerbose) {
                                                            if (!Actor) {
                                                                if (bVerbose) {
                                                                    UE_LOG(LogTemp, Warning,
                                                                           TEXT("CalculateChainMass: Null actor"));
                                                                }
                                                                return 0.0f;
                                                            }
                                                            ...
                                                            if (!Mesh) {
                                                                if (bVerbose) {
                                                                    UE_LOG(LogTemp, Warning,
                                                                           TEXT("CalculateChainMass: No "
                                                                                "SkeletalMeshComponent on %s"),
                                                                           *Actor->GetName());
                                                                }
                                                                return 0.0f;
                                                            }
                                                            ...
                                                            for (const FName& BoneName : BoneNames) {
                                                                ...
                                                                if (Body && Body->IsValidBodyInstance()) {
                                                                    ...
                                                                    UE_LOG(LogTemp, Warning,
                                                                           TEXT("CalculateChainMass: Missing or "
                                                                                "invalid body for bone %s on %s"),
                                                            ...
                                                            if (ValidCount == 0) {
                                                                if (bVerbose) {
                                                                    UE_LOG(LogTemp, Warning,
                                                                           TEXT("CalculateChainMass: No valid bones "
                                                                                "found on %s"),
                                                                           *Actor->GetName());
                                                                }
                                                                return 0.0f;
                                                        ...
                                                        AActor* UOHCombatUtils::FindMostLikelyOpponent(
                                                            const AActor* SelfActor, const FString& ContextualHint) {
                                                            if (!SelfActor)
                                                                return nullptr;
                                                            == == == = float UOHCombatUtils::CalculateChainMass(
                                                                         AActor * Actor, const TArray<FName>& BoneNames,
                                                                ...
                                                                if (ValidCount == 0) {
                                                                    if (bVerbose) {
                                                                        UE_LOG(LogTemp, Warning,
                                                                               TEXT("CalculateChainMass: No valid "
                                                                                    "bones found on %s"),
                                                                               *Actor->GetName());
                                                                    }
                                                                    return 0.0f;
...
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
                                                                ...
                                                                for (TActorIterator<AActor> It(World); It; ++It) {
                                                                    ...
                                                                    // --- Skip hitboxes/child actors if their
                                                                    // parent/owner is a Pawn/Character (common in
                                                                    // fighting games) ---
                                                                    if (Candidate->GetOwner() &&
                                                                        Candidate->GetOwner()->IsA(
                                                                            APawn::StaticClass()))
                                                                        continue;
                                                                    if (Candidate->GetAttachParentActor() &&
                                                                        Candidate->GetAttachParentActor()->IsA(
                                                                            APawn::StaticClass()))
                                                                        continue;

                                                                    // --- Optional: Skip actors that aren't Pawns (or
                                                                    // Characters, or your base combat class) --- If you
                                                                    // want to *only* ever target pawns/characters,
                                                                    // uncomment below: if
                                                                    // (!Candidate->IsA(APawn::StaticClass())) continue;

                                                                    // Or: if you have a base class like
                                                                    // AOHCombatCharacter if
                                                                    // (!Candidate->IsA(AOHCombatCharacter::StaticClass()))
                                                                    // continue;
                                                                ...
                                                                for (AActor* Candidate : Candidates) {
                                                                    ...
                                                                    const float Dist = FVector::Dist(
                                                                        SelfLoc, Candidate->GetActorLocation());
                                                                    Score += 1000.f / (Dist + 1.f);

                                                                    // Field of view
                                                                    const FVector ToTarget =
                                                                        (Candidate->GetActorLocation() - SelfLoc)
                                                                            .GetSafeNormal();
                                                                    const float Dot =
                                                                    ...
                                                                    if (!ContextualHint.IsEmpty()) {
                                                                        const FString TargetName =
                                                                            Candidate->GetName().ToLower();
                                                                        float FuzzyScore =
                                                                            UOHAlgoUtils::JaroWinklerDistance(
                                                                    ...
                                                                    if (Candidate->IsA(
                                                                            AOHCombatCharacter::StaticClass()))

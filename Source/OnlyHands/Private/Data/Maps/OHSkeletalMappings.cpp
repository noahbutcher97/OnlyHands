...
const TMap<EOHSkeletalBone, FName> SkeletalBoneToFNameMap = {{EOHSkeletalBone::None, FName("None")},
...
const TMap<FName, EOHSkeletalBone> FNameToSkeletalBoneMap = {{FName("None"), EOHSkeletalBone::None},
...
const TMap<EOHSkeletalBone, FName> PrimaryBoneToFNameMap = {
    {EOHSkeletalBone::Pelvis, FName("pelvis")},         {EOHSkeletalBone::Spine_01, FName("spine_01")},
    {EOHSkeletalBone::Spine_02, FName("spine_02")},     {EOHSkeletalBone::Spine_03, FName("spine_03")},
    {EOHSkeletalBone::Neck_01, FName("neck_01")},       {EOHSkeletalBone::Head, FName("head")},
    {EOHSkeletalBone::Clavicle_L, FName("clavicle_l")}, {EOHSkeletalBone::UpperArm_L, FName("upperarm_l")},
    {EOHSkeletalBone::LowerArm_L, FName("lowerarm_l")}, {EOHSkeletalBone::Hand_L, FName("hand_l")},
    {EOHSkeletalBone::Clavicle_R, FName("clavicle_r")}, {EOHSkeletalBone::UpperArm_R, FName("upperarm_r")},
    {EOHSkeletalBone::LowerArm_R, FName("lowerarm_r")}, {EOHSkeletalBone::Hand_R, FName("hand_r")},
    {EOHSkeletalBone::Thigh_L, FName("thigh_l")},       {EOHSkeletalBone::Calf_L, FName("calf_l")},
    {EOHSkeletalBone::Foot_L, FName("foot_l")},         {EOHSkeletalBone::Ball_L, FName("ball_l")},
    {EOHSkeletalBone::Thigh_R, FName("thigh_r")},       {EOHSkeletalBone::Calf_R, FName("calf_r")},
    {EOHSkeletalBone::Foot_R, FName("foot_r")},         {EOHSkeletalBone::Ball_R, FName("ball_r")}};
...
const TMap<EOHSkeletalBone, EOHBodyZone> BoneToZoneMap = {{EOHSkeletalBone::Spine_02, EOHBodyZone::Torso_Upper},
...
const TMap<EOHBodyZone, EOHSkeletalBone> ZoneToBoneMap = {
    {EOHBodyZone::Torso_Upper, EOHSkeletalBone::Spine_03},   {EOHBodyZone::Torso_Lower, EOHSkeletalBone::Pelvis},
    {EOHBodyZone::Cranial, EOHSkeletalBone::Head},           {EOHBodyZone::Arm_L_Upper, EOHSkeletalBone::UpperArm_L},
    {EOHBodyZone::Arm_L_Lower, EOHSkeletalBone::LowerArm_L}, {EOHBodyZone::Hand_L, EOHSkeletalBone::Hand_L},
    {EOHBodyZone::Arm_R_Upper, EOHSkeletalBone::UpperArm_R}, {EOHBodyZone::Arm_R_Lower, EOHSkeletalBone::LowerArm_R},
    {EOHBodyZone::Hand_R, EOHSkeletalBone::Hand_R},          {EOHBodyZone::Leg_L_Upper, EOHSkeletalBone::Thigh_L},
    {EOHBodyZone::Leg_L_Lower, EOHSkeletalBone::Calf_L},     {EOHBodyZone::Foot_L, EOHSkeletalBone::Foot_L},
    {EOHBodyZone::Leg_R_Upper, EOHSkeletalBone::Thigh_R},    {EOHBodyZone::Leg_R_Lower, EOHSkeletalBone::Calf_R},
...
const TMap<EOHBodyZone, TArray<EOHSkeletalBone>> ZoneToBonesMap = {
    ...
    {EOHBodyZone::Hand_L,
     {EOHSkeletalBone::Hand_L, EOHSkeletalBone::Thumb_01_L, EOHSkeletalBone::Thumb_02_L, EOHSkeletalBone::Thumb_03_L,
      ...
      EOHSkeletalBone::Ring_01_L, EOHSkeletalBone::Ring_02_L, EOHSkeletalBone::Ring_03_L, EOHSkeletalBone::Pinky_01_L,
    ...
    {EOHBodyZone::Hand_R,
     {EOHSkeletalBone::Hand_R, EOHSkeletalBone::Thumb_01_R, EOHSkeletalBone::Thumb_02_R, EOHSkeletalBone::Thumb_03_R,
      ...
      EOHSkeletalBone::Ring_01_R, EOHSkeletalBone::Ring_02_R, EOHSkeletalBone::Ring_03_R, EOHSkeletalBone::Pinky_01_R,
...
const TMap<EOHSkeletalBone, EOHBodyZone> PrimaryBoneToZoneMap = {
    {EOHSkeletalBone::Pelvis, EOHBodyZone::Torso_Lower},     {EOHSkeletalBone::Spine_01, EOHBodyZone::Torso_Lower},
    {EOHSkeletalBone::Spine_02, EOHBodyZone::Torso_Upper},   {EOHSkeletalBone::Spine_03, EOHBodyZone::Torso_Upper},
    {EOHSkeletalBone::Neck_01, EOHBodyZone::Cranial},        {EOHSkeletalBone::Head, EOHBodyZone::Cranial},
    {EOHSkeletalBone::Clavicle_L, EOHBodyZone::Arm_L_Upper}, {EOHSkeletalBone::UpperArm_L, EOHBodyZone::Arm_L_Upper},
    {EOHSkeletalBone::LowerArm_L, EOHBodyZone::Arm_L_Lower}, {EOHSkeletalBone::Hand_L, EOHBodyZone::Hand_L},
    {EOHSkeletalBone::Clavicle_R, EOHBodyZone::Arm_R_Upper}, {EOHSkeletalBone::UpperArm_R, EOHBodyZone::Arm_R_Upper},
    {EOHSkeletalBone::LowerArm_R, EOHBodyZone::Arm_R_Lower}, {EOHSkeletalBone::Hand_R, EOHBodyZone::Hand_R},
    {EOHSkeletalBone::Thigh_L, EOHBodyZone::Leg_L_Upper},    {EOHSkeletalBone::Calf_L, EOHBodyZone::Leg_L_Lower},
    {EOHSkeletalBone::Foot_L, EOHBodyZone::Foot_L},          {EOHSkeletalBone::Ball_L, EOHBodyZone::Foot_L},
    {EOHSkeletalBone::Thigh_R, EOHBodyZone::Leg_R_Upper},    {EOHSkeletalBone::Calf_R, EOHBodyZone::Leg_R_Lower},
    {EOHSkeletalBone::Foot_R, EOHBodyZone::Foot_R},          {EOHSkeletalBone::Ball_R, EOHBodyZone::Foot_R}};
...
const TMap<EOHBodyZone, TArray<EOHBodyPart>> ZoneToBodyPartsMap = {
    {EOHBodyZone::Torso_Upper, {EOHBodyPart::Torso}},     {EOHBodyZone::Torso_Lower, {EOHBodyPart::Pelvis}},
    {EOHBodyZone::Cranial, {EOHBodyPart::Head}},

    {EOHBodyZone::Arm_L_Upper, {EOHBodyPart::Arm_Left}},  {EOHBodyZone::Arm_L_Lower, {EOHBodyPart::Arm_Left}},
    {EOHBodyZone::Hand_L, {EOHBodyPart::Arm_Left}},

    {EOHBodyZone::Arm_R_Upper, {EOHBodyPart::Arm_Right}}, {EOHBodyZone::Arm_R_Lower, {EOHBodyPart::Arm_Right}},
    {EOHBodyZone::Hand_R, {EOHBodyPart::Arm_Right}},

    {EOHBodyZone::Leg_L_Upper, {EOHBodyPart::Leg_Left}},  {EOHBodyZone::Leg_L_Lower, {EOHBodyPart::Leg_Left}},
    {EOHBodyZone::Foot_L, {EOHBodyPart::Leg_Left}},

    {EOHBodyZone::Leg_R_Upper, {EOHBodyPart::Leg_Right}}, {EOHBodyZone::Leg_R_Lower, {EOHBodyPart::Leg_Right}},
...
const TMap<EOHFunctionalBoneGroup, TArray<EOHBodyZone>> FunctionalGroupToZonesMap = {
    ...
    {EOHFunctionalBoneGroup::UpperBody,
     {EOHBodyZone::Cranial, EOHBodyZone::Torso_Upper, EOHBodyZone::Arm_L_Upper, EOHBodyZone::Arm_R_Upper}},
    ...
    {EOHFunctionalBoneGroup::FullBody,
     {EOHBodyZone::Cranial, EOHBodyZone::Torso_Upper, EOHBodyZone::Torso_Lower, EOHBodyZone::Arm_L_Upper,
      EOHBodyZone::Arm_L_Lower, EOHBodyZone::Hand_L, EOHBodyZone::Arm_R_Upper, EOHBodyZone::Arm_R_Lower,
      EOHBodyZone::Hand_R, EOHBodyZone::Leg_L_Upper, EOHBodyZone::Leg_L_Lower, EOHBodyZone::Foot_L,
...
const TMap<EOHFunctionalBoneGroup, TArray<EOHBodyPart>> FunctionalGroupToBodyPartsMap = {
    ...
    {EOHFunctionalBoneGroup::UpperBody,
     {EOHBodyPart::Head, EOHBodyPart::Torso, EOHBodyPart::Arm_Left, EOHBodyPart::Arm_Right}},
    ...
    {EOHFunctionalBoneGroup::FullBody,
     {EOHBodyPart::Pelvis, EOHBodyPart::Torso, EOHBodyPart::Head, EOHBodyPart::Arm_Left, EOHBodyPart::Arm_Right,
...
const TMap<EOHSkeletalBone, EOHBodyPart> BoneToBodyPartMap = {{EOHSkeletalBone::Spine_01, EOHBodyPart::Torso},
...
const TMap<EOHBodyPart, EOHSkeletalBone> BodyPartToBoneMap = {{EOHBodyPart::Pelvis, EOHSkeletalBone::Pelvis},
...
const TMap<EOHSkeletalBone, EOHBodyPart> PrimaryBoneToBodyPartMap = {
    {EOHSkeletalBone::Pelvis, EOHBodyPart::Pelvis},        {EOHSkeletalBone::Spine_01, EOHBodyPart::Torso},
    {EOHSkeletalBone::Spine_02, EOHBodyPart::Torso},       {EOHSkeletalBone::Spine_03, EOHBodyPart::Torso},
    {EOHSkeletalBone::Neck_01, EOHBodyPart::Head},         {EOHSkeletalBone::Head, EOHBodyPart::Head},
    {EOHSkeletalBone::Clavicle_L, EOHBodyPart::Arm_Left},  {EOHSkeletalBone::UpperArm_L, EOHBodyPart::Arm_Left},
    {EOHSkeletalBone::LowerArm_L, EOHBodyPart::Arm_Left},  {EOHSkeletalBone::Hand_L, EOHBodyPart::Arm_Left},
    {EOHSkeletalBone::Clavicle_R, EOHBodyPart::Arm_Right}, {EOHSkeletalBone::UpperArm_R, EOHBodyPart::Arm_Right},
    {EOHSkeletalBone::LowerArm_R, EOHBodyPart::Arm_Right}, {EOHSkeletalBone::Hand_R, EOHBodyPart::Arm_Right},
    {EOHSkeletalBone::Thigh_L, EOHBodyPart::Leg_Left},     {EOHSkeletalBone::Calf_L, EOHBodyPart::Leg_Left},
    {EOHSkeletalBone::Foot_L, EOHBodyPart::Leg_Left},      {EOHSkeletalBone::Ball_L, EOHBodyPart::Leg_Left},
    {EOHSkeletalBone::Thigh_R, EOHBodyPart::Leg_Right},    {EOHSkeletalBone::Calf_R, EOHBodyPart::Leg_Right},
    {EOHSkeletalBone::Foot_R, EOHBodyPart::Leg_Right},     {EOHSkeletalBone::Ball_R, EOHBodyPart::Leg_Right}};
...
const TMap<EOHSkeletalBone, TArray<EOHFunctionalBoneGroup>> BoneToFunctionalGroupsMap = {
    ...
    {EOHSkeletalBone::Pelvis,
     {EOHFunctionalBoneGroup::Core, EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
    {EOHSkeletalBone::Spine_01,
     {EOHFunctionalBoneGroup::Core, EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
    {EOHSkeletalBone::Spine_02,
     {EOHFunctionalBoneGroup::Core, EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    {EOHSkeletalBone::Spine_03,
     {EOHFunctionalBoneGroup::Core, EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},

    // Cranial
    {EOHSkeletalBone::Neck_01,
     {EOHFunctionalBoneGroup::Cranial, EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    {EOHSkeletalBone::Head,
     {EOHFunctionalBoneGroup::Cranial, EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},

    // Left Arm
    {EOHSkeletalBone::Clavicle_L,
     {EOHFunctionalBoneGroup::LeftArm, EOHFunctionalBoneGroup::Arms, EOHFunctionalBoneGroup::LeftLimbs,
      EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Hand_L,
     {EOHFunctionalBoneGroup::LeftHand, EOHFunctionalBoneGroup::Hands, EOHFunctionalBoneGroup::LeftLimbs,
      EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Clavicle_R,
     {EOHFunctionalBoneGroup::RightArm, EOHFunctionalBoneGroup::Arms, EOHFunctionalBoneGroup::RightLimbs,
      EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Hand_R,
     {EOHFunctionalBoneGroup::RightHand, EOHFunctionalBoneGroup::Hands, EOHFunctionalBoneGroup::RightLimbs,
      EOHFunctionalBoneGroup::UpperBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Thigh_L,
     {EOHFunctionalBoneGroup::LeftLeg, EOHFunctionalBoneGroup::Legs, EOHFunctionalBoneGroup::LeftLimbs,
      EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Thigh_R,
     {EOHFunctionalBoneGroup::RightLeg, EOHFunctionalBoneGroup::Legs, EOHFunctionalBoneGroup::RightLimbs,
      EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Foot_L,
     {EOHFunctionalBoneGroup::LeftFoot, EOHFunctionalBoneGroup::Feet, EOHFunctionalBoneGroup::LeftLimbs,
      EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
    ...
    {EOHSkeletalBone::Foot_R,
     {EOHFunctionalBoneGroup::RightFoot, EOHFunctionalBoneGroup::Feet, EOHFunctionalBoneGroup::RightLimbs,
      EOHFunctionalBoneGroup::LowerBody, EOHFunctionalBoneGroup::FullBody}},
...
const TMap<EOHFunctionalBoneGroup, TArray<EOHSkeletalBone>> FunctionalGroupToBonesMap = {
    ...
    {EOHFunctionalBoneGroup::Hands,
     {EOHSkeletalBone::Hand_L,      EOHSkeletalBone::Hand_R,      EOHSkeletalBone::Thumb_01_L,
      EOHSkeletalBone::Thumb_02_L,  EOHSkeletalBone::Thumb_03_L,  EOHSkeletalBone::Index_01_L,
      EOHSkeletalBone::Index_02_L,  EOHSkeletalBone::Index_03_L,  EOHSkeletalBone::Middle_01_L,
      EOHSkeletalBone::Middle_02_L, EOHSkeletalBone::Middle_03_L, EOHSkeletalBone::Ring_01_L,
      EOHSkeletalBone::Ring_02_L,   EOHSkeletalBone::Ring_03_L,   EOHSkeletalBone::Pinky_01_L,
      EOHSkeletalBone::Pinky_02_L,  EOHSkeletalBone::Pinky_03_L,  EOHSkeletalBone::Thumb_01_R,
      EOHSkeletalBone::Thumb_02_R,  EOHSkeletalBone::Thumb_03_R,  EOHSkeletalBone::Index_01_R,
      EOHSkeletalBone::Index_02_R,  EOHSkeletalBone::Index_03_R,  EOHSkeletalBone::Middle_01_R,
      EOHSkeletalBone::Middle_02_R, EOHSkeletalBone::Middle_03_R, EOHSkeletalBone::Ring_01_R,
      EOHSkeletalBone::Ring_02_R,   EOHSkeletalBone::Ring_03_R,   EOHSkeletalBone::Pinky_01_R,
      EOHSkeletalBone::Pinky_02_R,  EOHSkeletalBone::Pinky_03_R}},
    ...
    {EOHFunctionalBoneGroup::Legs,
     {EOHSkeletalBone::Thigh_L, EOHSkeletalBone::Calf_L, EOHSkeletalBone::Thigh_R, EOHSkeletalBone::Calf_R}},
    ...
    {EOHFunctionalBoneGroup::Feet,
     {EOHSkeletalBone::Foot_L, EOHSkeletalBone::Ball_L, EOHSkeletalBone::Foot_R, EOHSkeletalBone::Ball_R}},
    {EOHFunctionalBoneGroup::UpperBody,
     {
         EOHSkeletalBone::Pelvis, EOHSkeletalBone::Spine_01, EOHSkeletalBone::Spine_02, EOHSkeletalBone::Spine_03,
         EOHSkeletalBone::Neck_01, EOHSkeletalBone::Head, EOHSkeletalBone::Clavicle_L, EOHSkeletalBone::UpperArm_L,
         EOHSkeletalBone::LowerArm_L, EOHSkeletalBone::Hand_L, EOHSkeletalBone::Clavicle_R, EOHSkeletalBone::UpperArm_R,
         EOHSkeletalBone::LowerArm_R,
         EOHSkeletalBone::Hand_R // Add fingers if needed
     }},
    {EOHFunctionalBoneGroup::LowerBody,
     {EOHSkeletalBone::Pelvis, EOHSkeletalBone::Thigh_L, EOHSkeletalBone::Calf_L, EOHSkeletalBone::Foot_L,
      EOHSkeletalBone::Ball_L, EOHSkeletalBone::Thigh_R, EOHSkeletalBone::Calf_R, EOHSkeletalBone::Foot_R,
      EOHSkeletalBone::Ball_R}},
    ...
    {EOHFunctionalBoneGroup::FullBody,
     {EOHSkeletalBone::Pelvis,     EOHSkeletalBone::Spine_01, EOHSkeletalBone::Spine_02,   EOHSkeletalBone::Spine_03,
      EOHSkeletalBone::Neck_01,    EOHSkeletalBone::Head,     EOHSkeletalBone::Clavicle_L, EOHSkeletalBone::UpperArm_L,
      EOHSkeletalBone::LowerArm_L, EOHSkeletalBone::Hand_L,   EOHSkeletalBone::Clavicle_R, EOHSkeletalBone::UpperArm_R,
      EOHSkeletalBone::LowerArm_R, EOHSkeletalBone::Hand_R,   EOHSkeletalBone::Thigh_L,    EOHSkeletalBone::Calf_L,
      EOHSkeletalBone::Foot_L,     EOHSkeletalBone::Ball_L,   EOHSkeletalBone::Thigh_R,    EOHSkeletalBone::Calf_R,
...
const TArray<EOHSkeletalBone> AllFingerBones = {
    // Left Hand Fingers
    EOHSkeletalBone::Thumb_01_L, EOHSkeletalBone::Thumb_02_L, EOHSkeletalBone::Thumb_03_L, EOHSkeletalBone::Index_01_L,
    EOHSkeletalBone::Index_02_L, EOHSkeletalBone::Index_03_L, EOHSkeletalBone::Middle_01_L,
    EOHSkeletalBone::Middle_02_L, EOHSkeletalBone::Middle_03_L, EOHSkeletalBone::Ring_01_L, EOHSkeletalBone::Ring_02_L,
    EOHSkeletalBone::Ring_03_L, EOHSkeletalBone::Pinky_01_L, EOHSkeletalBone::Pinky_02_L, EOHSkeletalBone::Pinky_03_L,

    // Right Hand Fingers
    EOHSkeletalBone::Thumb_01_R, EOHSkeletalBone::Thumb_02_R, EOHSkeletalBone::Thumb_03_R, EOHSkeletalBone::Index_01_R,
    EOHSkeletalBone::Index_02_R, EOHSkeletalBone::Index_03_R, EOHSkeletalBone::Middle_01_R,
    EOHSkeletalBone::Middle_02_R, EOHSkeletalBone::Middle_03_R, EOHSkeletalBone::Ring_01_R, EOHSkeletalBone::Ring_02_R,
    EOHSkeletalBone::Ring_03_R, EOHSkeletalBone::Pinky_01_R, EOHSkeletalBone::Pinky_02_R, EOHSkeletalBone::Pinky_03_R};

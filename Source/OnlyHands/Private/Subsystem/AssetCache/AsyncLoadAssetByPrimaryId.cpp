...
UAsyncLoadAssetByPrimaryId* UAsyncLoadAssetByPrimaryId::LoadPrimaryAssetAsync(UObject* WorldContextObject, FPrimaryAssetId AssetId)
{
...
void UAsyncLoadAssetByPrimaryId::Activate()
{
    ...
    Cache->RequestAsset(RequestedAssetId, FOnAssetLoadedNative::CreateUObject(this, &UAsyncLoadAssetByPrimaryId::OnAssetLoadedInternal));
}

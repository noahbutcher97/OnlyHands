...
bool SRhythmDebug::SupportsKeyboardFocus() const { return false; }
...
/*
        -----------------TICK---------------------
*/
void SRhythmDebug::Tick(const FGeometry &AllottedGeometry,
...
int32 SRhythmDebug::OnPaint(const FPaintArgs &Args,
  ...
  for (const FInputWindow &Window : InputWindows) {
    ...
    FSlateDrawElement::MakeBox(
        ...
        AllottedGeometry.ToPaintGeometry(StartPoint, EndPoint - StartPoint),

...
#define DEFINE_OH_MUTATION_WITH_CALLBACK_ACCESSORS(StructType, ValueType, FieldName, DebugLabel,                       \
                                                   ResolveInstanceLambda, CallbackLambda)                              \
  private:                                                                                                             \
    UPROPERTY()                                                                                                        \
...
#define DEFINE_OH_ANALYSIS_FIELD_ACCESSORS(ValueType, FieldName, DefaultValue)                                         \
  private:                                                                                                             \
    ...
    ValueType FieldName = DefaultValue;                                                                                \
                                                                                                                       \
  public:                                                                                                              \
    FORCEINLINE const ValueType& Get##FieldName() const {                                                              \
        return FieldName;                                                                                              \
    }                                                                                                                  \
                                                                                                                       \
  protected:                                                                                                           \
    FORCEINLINE ValueType& GetMutable##FieldName() {                                                                   \
        return FieldName;                                                                                              \
    }
...
#define DEFINE_OH_BUFFER_ACCESSORS(ValueType, FieldName)                                                               \
  ...
  public:                                                                                                              \
    ...
    FORCEINLINE int32 Get##FieldName##Count() const {                                                                  \
        return FieldName.Num();                                                                                        \
    }                                                                                                                  \
    FORCEINLINE void Reset##FieldName() {                                                                              \
        FieldName.Reset();                                                                                             \
    }                                                                                                                  \
    FORCEINLINE ValueType Get##FieldName##At(int32 Index) const {                                                      \
        return FieldName.IsValidIndex(Index) ? FieldName[Index] : ValueType();                                         \
                                                                                                                       ...
                                                                                                                       \
  protected:                                                                                                           \
    FORCEINLINE TArray<ValueType>& GetMutable##FieldName() {                                                           \
        return FieldName;                                                                                              \
    }
...
#define DEFINE_OH_LINKED_GRAPH_EDGE_ACCESSORS(EdgeType, FieldName)                                                     \
  ...
  public:                                                                                                              \
    ...
    FORCEINLINE bool Has##FieldName() const {                                                                          \
        return FieldName.Num() > 0;                                                                                    \
    }                                                                                                                  \
                                                                                                                       \
  protected:                                                                                                           \
    FORCEINLINE TArray<EdgeType>& GetMutable##FieldName() {                                                            \
        return FieldName;                                                                                              \
    }
...
#define DEFINE_OH_SMART_POINTER_ACCESSORS_CUSTOM(Type, FieldName, GetterName, SetterName, FallbackLambda, bLazyAssign) \
  private:                                                                                                             \
    Type FieldName = nullptr;                                                                                          \
                                                                                                                       \
  public:                                                                                                              \
    FORCEINLINE void SetterName(Type InPtr) {                                                                          \
        FieldName = InPtr;                                                                                             \
    }                                                                                                                  \
...
#define DEFINE_OH_MUTATION_NO_DIRTY_ACCESSORS_WITH_COMPARE(StructType, ValueType, FieldName, DebugLabel,               \
                                                           ResolveInstanceLambda)                                      \
  private:                                                                                                             \
    UPROPERTY()                                                                                                        \
    ValueType Cached##FieldName;                                                                                       \
                                                                                                                       \
...
#define DEFINE_OH_MUTATION_AND_NOTIFY_ACCESSORS_WITH_COMPARE(StructType, ValueType, FieldName, DebugLabel,             \
                                                             ResolveInstanceLambda, NotifierLambda)                    \
  private:                                                                                                             \
    UPROPERTY()                                                                                                        \
    ValueType Cached##FieldName;                                                                                       \
    UPROPERTY(Transient)                                                                                               \
  ...
  public:                                                                                                              \
    ...
    EOHMutationResult Set##FieldName(const ValueType& NewValue, bool bStrict = false, int32* OutMut = nullptr) {       \
        ...
        return TryApplyRuntimeMutation<ValueType, StructType>(                                                         \
            ...
            *this, DebugLabel, bStrict, OutMut, [this]() { Set##FieldName##Dirty(); });                                \
    }
...
#define DEFINE_OH_READONLY_ACCESSOR(ValueType, FieldName)                                                              \
    FORCEINLINE ValueType Get##FieldName() const {                                                                     \
        return Cached##FieldName;                                                                                      \
    }

#define DEFINE_OH_MUTATION_AND_NOTIFY_ACCESSORS_WITH_COMPARE_AND_CALLBACK(                                             \
    StructType, ValueType, FieldName, DebugLabel, ResolveInstanceLambda, NotifierLambda)                               \
  private:                                                                                                             \
...
#define DEFINE_OH_CONSTRAINT_FIELD_WITH_ACCESSORS(StructName, FieldType, FieldName, DefaultValue, DisplayName,         \
                                                  ConstraintAccessor)                                                  \

...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FFloatAxisInputDelegate, float,
                                            AxisValue);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_TwoParams(FVector2DAxisInputDelegate, float,
                                             ForwardValue, float, RightValue);
UCLASS()

...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnStartSwipe, ESwipeDirection, SwipeDirection, EInputType, InputType,
                                               FVector2D, SwipeVelocity);
DECLARE_DYNAMIC_MULTICAST_DELEGATE_ThreeParams(FOnDuringSwipe, ESwipeDirection, SwipeDirection, EInputType, InputType,
                                               FVector2D, SwipeVelocity);
...
class ONLYHANDS_API UInputPanel2D : public UWidget {
  ...
  public:
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input Parameters",
              meta = (ToolTip = "If >= 0: sends tap event after this many frames while touch is held."))
    int AutoTriggerTapFrames = -1;

    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input Parameters",
              meta = (ToolTip = "Number of frames delay for start hold. Also max number of frames for tap."))
    int HoldFrames = 3;
    ...
    UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Input Parameters",
              meta = (ToolTip = "0.0-1.0, how hard it is to draw curve, closer to 1 means easier"))

...
struct FPhysicalAnimationBoneDriveInstance {
  ...
  FPhysicalAnimationBoneDriveInstance()
      : TargetActor(), ConstraintInstance(nullptr), BlendAlpha(1.f),
        bActive(false) {}
};
...
DECLARE_DYNAMIC_MULTICAST_DELEGATE_OneParam(FOnPhysicsInstability, FName,
                                            ChainName);
// --------- MAIN COMPONENT ---------
...
public:
  ...
  UFUNCTION(CallInEditor, BlueprintCallable, Category = "Physical Animation")
  void SetDriveProfileForChain(FName ChainName,
                               UOHPhysicalAnimationProfileDataAsset *Profile);

  UFUNCTION(CallInEditor, BlueprintCallable, Category = "Physical Animation")
  void PreviewChainsInEditor();

  FPhysicalAnimationDriveSettings GetDefaultDriveForChain(FName StartBone,
                                                          FName EndBone);
  ...
  UFUNCTION(BlueprintCallable, Category = "Physical Animation")
  void
  SetChainDriveSettings(FName ChainName,
                        const FPhysicalAnimationDriveSettings &NewSettings);

  UFUNCTION(CallInEditor, BlueprintCallable,
            Category = "Physical Animation|Setup")
  ...
  EnsureBodyForBone_Static(FName BoneName,
                           USkeletalMeshComponent *SkeletalMeshComponent,
                           UPhysicsAsset *PhysicsAsset);
  static FConstraintInstance *EnsureConstraintBetweenBones_Static(
      FName Bone1, FName Bone2, USkeletalMeshComponent *SkeletalMeshComponent,
      UPhysicsAsset *PhysicsAsset);
  static FConstraintInstance *EnsureBodiesAndConstraint_Static(
      FName Bone1, FName Bone2, USkeletalMeshComponent *SkeletalMeshComponent,
      UPhysicsAsset *PhysicsAsset);
#endif
...
private:
  ...
  void
  CreateBoneDriveInstance(FPhysicalAnimationBoneDriveInstance &BoneDrive,
  ...
  static void
  UpdateBoneDriveInstance(FPhysicalAnimationBoneDriveInstance &BoneDrive,

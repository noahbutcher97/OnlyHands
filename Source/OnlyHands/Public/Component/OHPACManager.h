...
public:
  ...
  TMap<EPhysicalAnimationProfile, FPhysicalAnimationData>
  ...
  // UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = "Physics
  // Snapshot")
  TMap<FBodyInstance *, TArray<FConstraintInstance *>>
      BodyInstanceToConstraintInstances;
  ...
  void VisualizePhysicsSnapshot(bool bDrawBodies = true,

 ...
 * Each implementation returns a resolved target pose/force/damping for a given
 * bone.
 */
...
public:
   ...
   */
  virtual FOHResolvedPhysicsTargets Resolve(const FOHBoneState &BoneState,
                                            EOHSkeletalBone Bone) const = 0;

...
<<<<<<< HEAD
      public:
        static void AddCharacterUpdateState(ACharacter* Character,
...
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
          ...
          static void
          AddCharacterUpdateState(ACharacter * Character, UPARAM(ref) TArray<ACharacter*>& OverlappingCharacters,
                                  FVector SourceLocation, ERotationContext CurrentState, ERotationContext& NextState,
...
<<<<<<< HEAD
        ...
        == == == = static void RemoveCharacterUpdateState(
                     ACharacter * Character, TArray<ACharacter*>& OverlappingCharacters, FVector SourceLocation,
                     ERotationContext CurrentState, ERotationContext& NextState, ACharacter*& ClosestCharacter);
...
<<<<<<< HEAD
         ...
         */
        UFUNCTION(BlueprintPure, Category = "Character|Utils")
        static bool GetClosestCharacterToLocationFromActors(const FVector& SourceLocation,
        ...
        == == == =
            ...
            UFUNCTION(BlueprintPure, Category = "Posture|Spine") static bool IsCharacterLeaningForward(
                USkeletalMeshComponent * Mesh, FName SpineBone = "spine_03");
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
        ...
        static bool IsActorWithinRange(const AActor* Source, const AActor* Target, float MaxDistance,
                                       float Radius = 0.f);
...
#pragma region Animation
        ...
        static void BeginDeferredStrikeSweep(UPARAM(ref) FDeferredStrikeSweepState& State, USkeletalMeshComponent* Mesh,
                                             AActor* Owner, const TArray<FName>& BoneChain,
        ...
        UFUNCTION(BlueprintPure, Category = "Combat|Animation")
        static bool IsOutsideMontageSectionWindow(const FOHMontagePlaybackState& State, float WindowStart,
                                                  float WindowEnd);

        /** True if within normalized segment play window */
        UFUNCTION(BlueprintPure, Category = "Combat|Animation")
        static bool IsInMontageSegmentWindow(const FOHMontagePlaybackState& State, float SegmentStart,
                                             float SegmentEnd);
        ...
        static bool ResolveAnimSequenceAtTimeRecursive(UAnimSequenceBase* AnimBase, float Time,
...
<<<<<<< HEAD
        ...
        UFUNCTION(BlueprintPure, Category = "OH|Combat|Contact",
                  meta = (DisplayName = "Calculate Deflection Direction"))
        static FVector CalculateDeflectionDirection(const FVector& IncomingWorldVelocity, const FVector& ContactNormal,
            ...
            FVector Reflected = IncomingWorldVelocity -
                                2.0f * FVector::DotProduct(IncomingWorldVelocity, ContactNormal) * ContactNormal;
...
>>>>>>> 0627b7d296554ee97d27b39fb5f7c959d6da32c9
                     ...
                     // Calculate contact quality from bone velocities in world space (0=tangential, 1=perpendicular)
            UFUNCTION(BlueprintPure, Category = "OH|Combat|Contact",
                      meta = (DisplayName = "Calculate Contact Quality")) static float
            CalculateContactQuality(const FVector& StrikingBoneWorldVelocity, const FVector& ContactNormal,
                                    const FVector& TargetBoneWorldVelocity = FVector::ZeroVector) {
            FVector RelativeVelocity = StrikingBoneWorldVelocity - TargetBoneWorldVelocity;
            float Speed = RelativeVelocity.Size();
        ...
        UFUNCTION(BlueprintCallable, Category = "Combat|Debug")
        static void DrawDebugStrikeCone(const UObject* WorldContextObject, const FVector& Origin,
                                        const FVector& Velocity, float Length = 100.f, float AngleDegrees = 30.f,
                                        FColor Color = FColor::White, float Duration = 1.f, float Thickness = 1.f);
        ...
        UFUNCTION(BlueprintCallable, Category = "OH|Combat|Sampling")
        static bool GetBoneTransformFromAnimBase(UAnimSequenceBase* AnimBase, USkeletalMeshComponent* Mesh,
        ...
        static FTransform GetBoneComponentSpaceTransformAtTime(UAnimSequence* Sequence,
                                                               const USkeletalMeshComponent* Mesh, FName BoneName,
                                                               double Time);

        static FAnimExtractContext MakeExtractContext(double Time, bool bExtractRootMotion = false,
                                                      bool bLooping = false) {
        ...
        static bool GenerateStrikeArcFromAnimBase(UAnimSequenceBase* AnimBase, USkeletalMeshComponent* Mesh,
                                                  FName BoneName, float StartTime, float EndTime,
                                                  TArray<FVector>& OutPoints, float SampleRate = 60.f);

        /** Runtime-safe arc sampling using time-based SampleRate (Hz). */
        UFUNCTION(BlueprintCallable, Category = "OH|Combat|ArcSampling")
        static bool GenerateStrikeArcFromAnimSequence(UAnimSequence* Sequence, USkeletalMeshComponent* Mesh,
                                                      FName BoneName, float StartTime, float EndTime,
                                                      TArray<FVector>& OutPoints, float SampleRate = 60.f);
        ...
        static bool GenerateStrikeArcFromAnimSequence_FixedResolution(UAnimSequence* Sequence,
                                                                      USkeletalMeshComponent* Mesh, FName BoneName,
                                                                      int32 NumSamples, float StartTime, float EndTime,
                                                                      TArray<FVector>& OutPoints);

        UFUNCTION(BlueprintCallable, Category = "OH|Combat|ArcSampling")
        static bool GenerateStrikeArcFromComposite(UAnimComposite* Composite, USkeletalMeshComponent* Mesh,
                                                   FName BoneName, float StartTime, float EndTime,
                                                   TArray<FVector>& OutPoints, float SampleRate = 60.f);
        ...
        static FCombatStrikePredictionResult PredictStrikeCollision(const UObject* WorldContextObject,
                                                                    ACharacter* Attacker,
        ...
        AnalyzeStrikeTrajectoryAndTargeting(const UObject* WorldContextObject, ACharacter* Attacker,
...
#pragma region Sampling
        ...
        static FOHBoneMotionSample SampleBoneMotionFromAnimBase(
            ...
            float StartTime = -1.f, float EndTime = -1.f, FName MontageSectionName = NAME_None, bool bDrawDebug = false,
            FColor DebugColor = FColor::White, float DebugDuration = 2.0f, float DebugThickness = 2.0f);
        ...
        UFUNCTION(BlueprintCallable, Category = "OH|Combat|ArcSampling|Debug")
        static void VisualizePredictedArc(const UObject* WorldContextObject, USkeletalMeshComponent* Mesh,
      ...
      private:
        ...
        static FVector GetBlendedChainAcceleration(UOHPhysicsManager* PhysicsManager,
                                                   const USkeletalMeshComponent* Mesh, FName StartBone, FName EndBone,
                                                   float HistoryWeight = 0.5f, int NumSamples = 5);
...
#pragma region InlineFunctions
        ...
        static FVector GetEnhancedPredictedDirection(const FOHBoneData* BoneData) {
            ...
            const FVector AngularInfluence =
                FVector::CrossProduct(BoneData->GetBodyAngularVelocity(), FVector::UpVector);
...
<<<<<<< HEAD
        ...
        == == == =
                     // Predictive, capsule-based foot ground trace with debug
            static bool PredictiveCapsuleGroundTrace(USkeletalMeshComponent * Mesh, FName BoneName, float MaxDistance,
                                                     float TraceForwardBias, float CapsuleRadius,
                                                     float CapsuleHalfHeight, const FVector& OwnerVelocity,

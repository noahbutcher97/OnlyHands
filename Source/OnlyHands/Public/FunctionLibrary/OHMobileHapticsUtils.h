...
class ONLYHANDS_API UOHMobileHapticsUtils : public UBlueprintFunctionLibrary {
  GENERATED_BODY()
public:
  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void PlayMobileHapticPatternEx(UObject *WorldContext,
  ...
  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void
  PlayMobileHapticSimple(UObject *WorldContext, float Intensity = 1.0f,
                         float Sharpness = 1.0f, float Duration = 0.1f,
                         bool bTransient = true, bool bLeftHand = false);
  ...
  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void PlayMobileHapticCurve(UObject *WorldContext,
                                    UCurveFloat *IntensityCurve, float Duration,
  ...
  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void PlayMobileHapticCurve_FixedRate(UObject *WorldContext,
  ...
  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void PlayMobileHapticCurve_Keys(UObject *WorldContext,
                                         UCurveFloat *IntensityCurve,
                                         float Duration);

  UFUNCTION(BlueprintCallable, Category = "OnlyHands|Mobile|Haptics",
            meta = (WorldContext = "WorldContext"))
  static void PlayMobileHapticCurve_Auto(UObject *WorldContext,
                                         UCurveFloat *IntensityCurve,
                                         float Duration,
                                         float SampleRate = 60.f);
};

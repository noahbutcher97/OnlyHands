...
public:
	...
	UPROPERTY(BlueprintReadOnly, Category = "Defence", ReplicatedUsing = OnRep_Defence)
	...
	UPROPERTY(BlueprintReadOnly, Category = "Special", ReplicatedUsing = OnRep_Special)
	FGameplayAttributeData Special;
	ATTRIBUTE_ACCESSORS(UOHCombatAttributeSet, Special)

	UPROPERTY(BlueprintReadOnly, Category = "SpecialBar", ReplicatedUsing = OnRep_Special)
	...
	UPROPERTY(BlueprintReadOnly, Category = "Momentum", ReplicatedUsing = OnRep_Momentum)
	FGameplayAttributeData Momentum;
	ATTRIBUTE_ACCESSORS(UOHCombatAttributeSet, Momentum)

	UPROPERTY(BlueprintReadOnly, Category = "Momentum", ReplicatedUsing = OnRep_MaxMomentum)
	FGameplayAttributeData MaxMomentum;
	ATTRIBUTE_ACCESSORS(UOHCombatAttributeSet, MaxMomentum)

	UPROPERTY(BlueprintReadOnly, Category = "CritChance", ReplicatedUsing = OnRep_CritChance)
	FGameplayAttributeData CritChance;
	ATTRIBUTE_ACCESSORS(UOHCombatAttributeSet, CritChance)

	UPROPERTY(BlueprintReadOnly, Category = "StaggerResistance", ReplicatedUsing = OnRep_StaggerResistance)
	FGameplayAttributeData StaggerResistance;
	ATTRIBUTE_ACCESSORS(UOHCombatAttributeSet, StaggerResistance)

	UPROPERTY(BlueprintReadOnly, Category = "StaggerResistance", ReplicatedUsing = OnRep_MaxStaggerResistance)
...
protected:
	...
	UFUNCTION()
	virtual void OnRep_MaxSpecialBar(const FGameplayAttributeData& OldMaxSpecialBar);
	...
	UFUNCTION()
	virtual void OnRep_MaxStaggerResistance(const FGameplayAttributeData& OldMaxStaggerResistance);
